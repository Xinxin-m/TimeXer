...
model = AutonomousFreeflyerTransformer(config)  # AutonomousFreeflyerTransformer_pred_time(config) 
...
def evaluate():
    ...
    for step in range(eval_iters):
        ...
        with torch.no_grad():
            # input parameters for the model are defined in the forward method of AutonomousFreeflyerTransformer
