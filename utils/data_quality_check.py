...
def find_nan_rows(filepath, column='log_return', n_rows=5):
    """
...
def main():
    ...
    parser.add_argument('--find_nan', action='store_true', help='Find and print rows with NaN values')
    parser.add_argument('--column', type=str, default='log_return', help='Column to check for NaN values')
    parser.add_argument('--n_rows', type=int, default=5, help='Number of rows to print before and after NaN values')
